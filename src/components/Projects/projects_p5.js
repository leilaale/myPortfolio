    ...
    projects: [
      {
        ...
        slides: [
          ...
          },
          {
            ...
            title: "Slide 3",
            description:
              "#2a Translate transcription using AWS Transcription Service",
          },
          {
            type: "image",
            source: awsImg4,
            title: "Slide 4",
            description:
              "#3a Added a Parallel State to translate and create a poem",
          },
        ],
      },
      {
        ...
        teamSize: 1,
        objective:
          "Learn how to make a weather chatbot with AWS Bedrock Knowledge Base, Agents, and Claude using an API",
        resources: "LinkedIn Course, AWS Services",
        cardDescription:
          "Created a Knowledge Base connected to a csv file that contained city names with their latitude and longitude. The file was saved in an S3 Bucket, with the openAI file. The API would get back with the weather for the city that the user decided to look up. They would be able to look up today's weather or a forecast of 5 days. ",
        hashTags:
          "#AWS #AWSBedrock #S3Bucket #Claude #BedrockAgent #BackEnd #JSON #Javascript #YML #KnowledgeBase",
        gitLink:
          "https://github.com/leilaale/awsLearning/tree/master/weatherChatbot",
        slides: [
          {
            type: "image",
            source: awsImg5,
            title: "Slide 1",
            description: "1. Results for today's weather for El Paso, TX",
          },
          {
            type: "image",
            source: awsImg6,
            title: "Slide 2",
            description: "2. Results for a 5 days' forecast for El Paso, TX",
          },
          {
            type: "image",
            source: awsImg7,
            title: "Slide 3",
            description: "3. Results for today's weather for Denver, Colorado",
          },
          {
            type: "image",
            source: awsImg8,
            title: "Slide 4",
            description:
              "4. Results for a 5 days' forecast for Denver, colorado",
          },
        ],
      },
    ...
    projects: [
      {
        ...
        teamSize: 2,
        objective:
          "Create an app that integrates with a public API to gather and display real-time car data to users, providing an interactive and user-friendly interface.",
        resources: "car API",
        cardDescription: `
                    ...
                    `,
        hashTags:
          "#Flutter #Dart #CarRecommendation #MobileAppDevelopment #APIIntegration #AppDevelopment #VehicleFinder #UIUXDesign #CrossPlatformDevelopment #TechForCars",
        gitLink: "https://github.com/carevilla/Build-A-Car",
        slides: [
          {
            type: "image",
            source: imagesSrc.buildACar.mainFamilyCar,
            title: "Slide 1",
            description: "1. Main Page Family Car Tab",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.mainSportsCar,
            title: "Slide 2",
            description: "2. Main Page Sports Car Tab",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.mainFavorite,
            title: "Slide 3",
            description: "3. Main Page Favorite",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.searchBar,
            title: "Slide 4",
            description: "4. Map",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.sideBar,
            title: "Slide 5",
            description: "5. Side Bar",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.logInPage,
            title: "Slide 6",
            description: "6. Login Page",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.loggedIn,
            title: "Slide 7",
            description: "7. Logged In Page",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.logInError,
            title: "Slide 8",
            description: "8. Logging Error 1",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.logInError2,
            title: "Slide 9",
            description: "9. Logging Error 2",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.van,
            title: "Slide 10",
            description: "10. Build Van Options",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.truck,
            title: "Slide 11",
            description: "11. Build Truck Options",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.suv,
            title: "Slide 12",
            description: "12. Build SUV Options",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.sports,
            title: "Slide 13",
            description: "13. Build Sports Car",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.sportOptions,
            title: "Slide 14",
            description: "14. Sports Car Options",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.sportResults,
            title: "Slide 15",
            description: "15. Sports Car Results",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.phone,
            title: "Slide 16",
            description: "16. Sample Phone to call Dealers",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.map,
            title: "Slide 17",
            description: "17. Map",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.list,
            title: "Slide 18",
            description: "18. Saved Cars List",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.favorites,
            title: "Slide 19",
            description: "19. Favorites List",
          },
          {
            type: "image",
            source: imagesSrc.buildACar.delete,
            title: "Slide 20",
            description: "20. Delete From List",
          },
        ],
      },
      {
        ...
        teamSize: 1,
        objective:
          "Use an HTTP Request for Authentication and Quiz questions and use different Widgets",
        ...
        hashTags:
          "#Flutter #BackEnd #FrontEnd #Dart #HTTPRequest #Authentication",
        gitLink: "https://github.com/leilaale/flutter_QuizApp",
        slides: [
          {
            type: "image",
            source: flutter_quizApp_logIn,
            title: "Slide 1",
            description: "1. Log In",
          },
          {
            type: "image",
            source: flutter_quizApp_logInError,
            title: "Slide 2",
            description: "2. Log In Error",
          },
          {
            type: "video",
            source: flutter_quizApp_loading,
            title: "Slide 3",
            description: "3. Loading Indicator",
          },
          {
            type: "image",
            source: flutter_quizApp_numQuestions,
            title: "Slide 4",
            description: "4. Select how any questions on quiz",
          },
          {
            type: "image",
            source: flutter_quizApp_questionSample1,
            title: "Slide 5",
            description: "5. Question Sample 1",
          },
          {
            type: "image",
            source: flutter_quizApp_questionSample2,
            title: "Slide 6",
            description: "6. Question Sample 2",
          },
          {
            type: "video",
            source: flutter_quizApp_ansSelection,
            title: "Slide 7",
            description: "7. Answer Selection",
          },
          {
            type: "image",
            source: flutter_quizApp_checkQuestions,
            title: "Slide 8",
            description: "8. Check Questions on Quiz",
          },
          {
            type: "image",
            source: flutter_quizApp_results,
            title: "Slide 9",
            description: "9. See results",
          },
          {
            type: "image",
            source: flutter_quizApp_review,
            title: "Slide 10",
            description: "10. Review Questions with Answers",
          },
        ],
      },
      {
        ...
        cardDescription:
          "Created a simple page design that would show the current value of Bitcoin. Main goal was to know how to call an API and showcase that information in the app. ",
        hashTags: "#Flutter #BackEnd #FrontEnd #Dart #Button",
        gitLink: "Null",
        slides: [
          {
            type: "video",
            source: flutter_bitcoin,
            title: "Slide 1",
            description: "1. Video Demonstration",
          },
          {
            type: "image",
            source: flutter_bitcoin2,
            title: "Slide 2",
            description: "2. Sample",
          },
          {
            type: "image",
            source: flutter_bitcoin3,
            title: "Slide 3",
            description: "3. Sample",
          },
        ],
      },
    ],
