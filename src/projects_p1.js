        ...
        <div class = "tab-projects active-p-tab" id="project1">
                        ...
                        <div class = "project-description">
                            <div class = 'description_2'>
                                <p><span id="project-subtitle">Class: </span> Self-Project</p>
                                <p><span>Skills Learned:</span> Flutter, Cross-programming, REST APIs, Firebase Authorization, Firestore Database, State Management</p>
                                <p><span>Soft Skills:</span> Team work, Presentation Skills, Initiative, Problem-Solving, Time Management</p>
                                <p><span>Team size:</span> 1 (Individual)</p>
                                <p><span>Description: </span>
                                    <span className="projectCard_InnerDescription" dangerouslySetInnerHTML={{ __html: sanitizedDescription }}>
                                    </span>
                                </p>
                            </div>
                        </div>
