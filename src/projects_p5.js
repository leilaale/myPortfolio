        ...
        projects: [
            {
                ...
                slides:[
                        ...
                        { type: 'image', source: imagesSrc.buildACar.mainFavorite, title: 'Slide 3', description: "3. Main Page Favorite"},
                        { type: 'image', source: imagesSrc.buildACar.searchBar, title: 'Slide 4', description: "4. Map"},
                        { type: 'image', source: imagesSrc.buildACar.sideBar, title: 'Slide 5', description: "5. Side Bar"},
                        { type: 'image', source: imagesSrc.buildACar.logInPage, title: 'Slide 6', description: "6. Login Page"},
                        { type: 'image', source: imagesSrc.buildACar.loggedIn, title: 'Slide 7', description: "7. Logged In Page"},
                        { type: 'image', source: imagesSrc.buildACar.logInError, title: 'Slide 8', description: "8. Logging Error 1"},
                        { type: 'image', source: imagesSrc.buildACar.logInError2, title: 'Slide 9', description: "9. Logging Error 2"},
                        { type: 'image', source: imagesSrc.buildACar.van, title: 'Slide 10', description: "10. Build Van Options"},
                        { type: 'image', source: imagesSrc.buildACar.truck, title: 'Slide 11', description: "11. Build Truck Options"},
                        { type: 'image', source: imagesSrc.buildACar.suv, title: 'Slide 12', description: "12. Build SUV Options"},
                        { type: 'image', source: imagesSrc.buildACar.sports, title: 'Slide 13', description: "13. Build Sports Car"},
                        { type: 'image', source: imagesSrc.buildACar.sportOptions, title: 'Slide 14', description: "14. Sports Car Options"},
                        { type: 'image', source: imagesSrc.buildACar.sportResults, title: 'Slide 15', description: "15. Sports Car Results"},
                        { type: 'image', source: imagesSrc.buildACar.phone, title: 'Slide 16', description: "16. Sample Phone to call Dealers"},
                        { type: 'image', source: imagesSrc.buildACar.map, title: 'Slide 17', description: "17. Map"},
